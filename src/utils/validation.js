...
export const aiGenerateSchema = z.object({
    ...
    section: z.enum(["summary", "experience", "education", "skills", "projects", "personalInfo"], {
        errorMap: () => ({
            message:
                "Invalid section. Must be one of: summary, experience, education, skills, projects, personalInfo",
        }),
    }),
